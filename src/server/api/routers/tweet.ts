...
export const tweetRouter = createTRPCRouter({
  ...
  infiniteProfileFeed: publicProcedure.input(
    ...
    return await getInfiniteTweets({limit, ctx, cursor, whereClause: {userId} })
  }),
  ...
  infiniteFeed: publicProcedure.input(
    ...
    const currentUserId = ctx.session?.user.id
    return await getInfiniteTweets({limit, ctx, cursor, whereClause: currentUserId == null || !onlyFollowing ? undefined : {
      user: {
